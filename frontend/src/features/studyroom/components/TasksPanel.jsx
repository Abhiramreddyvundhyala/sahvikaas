        ...
        {tasks.map(task => (
          <div key={task.id} className="flex items-start gap-2 p-2 group">
            <input
              ...
              className="mt-1 rounded border-gray-300 text-black focus:ring-[#F2CF7E]"
            />
      ...
      <Modal isOpen={showAddModal} onClose={() => setShowAddModal(false)}>
        <div className="p-5">
          ...
          <div className="flex gap-2 mt-4 justify-end">
            ...
            <button onClick={addTask} className="px-3 py-1.5 text-sm bg-[#F2CF7E] text-white rounded-lg hover:bg-[#e0bd6c]">
              Save
            </button>
          </div>
        </div>
